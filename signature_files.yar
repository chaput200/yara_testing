...
rule sign_183a { condition: uint32be(null) == 0x43415420 } // EA Interchange Format File (IFF)_3: IFF
rule sign_183b { condition: uint32be(0) == 0x43415420 } // EA Interchange Format File (IFF)_3: IFF
